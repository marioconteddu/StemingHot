...
class DemucsWrapper(ModelInterface):
    """
    Wrapper for Hybrid Transformer Demucs (htdemucs_ft).
    ...
    def __init__(self, model_name: str = "htdemucs_ft"):
        ...
        self._model = None
        self._device = "cpu"
        self._stems = ["drums", "bass", "other", "vocals"]
    ...
    def separate(
        ...
        **kwargs,
        ...
        if progress_callback:
            progress_callback(0.05, "Running model inference...")
